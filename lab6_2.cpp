...
double findXComponent(double d1,double d2,double o1,double o2){
    return d1*cos(o1) + d2*cos(o2);
}

double findYComponent(double d1,double d2,double o1,double o2){
    return d1*sin(o1) + d2*sin(o2);
}
